        ...
        scope module: :accounts do
          ...
          namespace :bloomwire do
            ...
            namespace :whatsapp do
              ...
              # Phase 5 (resume): re-verify outbound messaging capability for an existing Action-Required setup
              # (:id = Bloomwire::WhatsappSetup id) and, when the owner has since granted the Meta task, promote it
              # to routeable-ready. Admin-only; inert (404) unless managed self-serve. Safe DTO; no /register, no dup.
              resources :messaging_capabilities, only: [:update]
            end
