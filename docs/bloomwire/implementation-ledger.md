...
| Managed WhatsApp honest progress | Replace unreachable generic Add Agents/Finish sidebar steps with the real `Choose Channel → Connect WhatsApp` flow; success card owns Done | #159 | Implemented · review/CI/DEV pending |
...
### Managed WhatsApp honest progress — `Implemented · PR #159 · merge/DEV pending`
