...
### ADR-0010 Section A — Synchronous WhatsApp onboarding timeout resilience + convergent retry — `Merged · PR #152 · e83036a; deploy pending with async`
