...
| Atomic WhatsApp Remove Inbox | Transactional dependency ordering + DB persistence fence + exact unbound-attempt identity, audit detachment, safe retries, truthful 202 pending UI | #166 | Base `52e5524` · fence `8403cc5` · review `4679498933` fix `ba62ba7` · refreshed final-head CI/review pending · DEV recovery not performed |
| WhatsApp provider migration + truthful disconnect/removal | Recommended "Move Existing Cloud API Number" option (explicit confirm + prerequisites/ack gate, reuses Standard lifecycle `coexistence:false`); signed front door splits batched changes exactly once and sends only `account_update/PARTNER_REMOVED` to the reconciler; persisted-status **Refresh**; Standard disconnect requires an account/inbox/channel/phone-aligned preserved Setup before Meta and verifies DISCONNECTED; local-only Remove Inbox copy | #165 | Implemented · **three exact-head rounds applied; review `4678508407` blockers fixed in `6a0e715`** · front-door 19/0 · disconnect service 12/0 · request 8/0 · relevant BE 107/0 · broad BE 1188/0 (41 pending) · FE 192/0 · lint/build/gates clean · implementation self-validation only, independent QA/CI/DEV/real-Meta cert pending · open/not merged/deployed |
...
### Atomic, dependency-safe WhatsApp Remove Inbox — `Implemented · PR #166 · base 52e5524 · fence 8403cc5 · review 4679498933 identity ba62ba7 · not deployed`
...
### WhatsApp provider migration + truthful disconnect/removal — `Implemented · PR #165 open · review 4678508407 fixes in 6a0e715 · independent QA/CI/DEV pending · not merged/deployed`
